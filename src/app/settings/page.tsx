    ...
    <div className="w-full flex flex-col gap-4">
      <div className="w-full flex flex-row gap-4">
        <div className="flex flex-col gap-4 min-w-[30%]">
          <div className="flex gap-5 bg-componentBg border border-borderColor rounded-lg p-6">
            <Image
              src="/neil-sims.png"
              alt="Avatar"
              height="112"
          ...
          <div className="bg-componentBg rounded-lg w-full  p-6">
        ...
        <div className="w-full bg-componentBg border border-borderColor rounded-lg p-6"></div>
      </div>
      <Footer />
